...
HTML5Caption_convertDFXP2HTMLAttributes = function(dfxpElement, htmlElement, hasOrigin, top, left) {
	...
	if (v != "auto" && v != "inherit") {
		...
		if (!hasOrigin) {
		    ...
		    htmlElement.style.setProperty("left", (left + HTML5Caption_toPixels(p[0])*htmlElement.dfxp_width/100) + "px", "");
		    htmlElement.style.setProperty("top", (top + HTML5Caption_toPixels(p[1])*htmlElement.dfxp_height/100) + "px", "");
